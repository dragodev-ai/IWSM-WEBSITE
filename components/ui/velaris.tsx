...
interface VelarisProps extends React.HTMLAttributes<HTMLDivElement> {
...
const DEFAULT_BLUE_PALETTE: [string, string, string, string] = [
  "#020617", // Deep midnight obsidian
  "#0a1e48", // Dark ocean navy
  "#1d4ed8", // Royal sapphire blue
  "#38bdf8", // Electric cyan flare
];
...
const FS_SOURCE = `
  ...
  void main() {
    ...
    col = mix(col * 0.45, col, mix(1.0, vignette, u_vignette));
...
export function Velaris({
  ...
  useEffect(() => {
    ...
    gl.uniform3f(uC3, rgb3[0], rgb3[1], rgb3[2]);
    gl.uniform3f(uC4, rgb4[0], rgb4[1], rgb4[2]);
  ...
  }, [colors, speed, grainIntensity, vignetteStrength]);
