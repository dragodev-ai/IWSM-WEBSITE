...
export function ShinyButton({
  ...
  onClick,
  className = "",
  fillColor = "#061224", // Premium midnight navy base
  labelColor = "#ffffff", // Crisp luminescent white
  accentColor = "#2563eb", // Royal electric blue gleam
  accentSoftColor = "#38bdf8", // Electric cyan accent glow
  sweepDuration = 3,
  easeDuration = 0.8,
  arcWidth = 6,
  cornerRadius = 32,
  ...
  const css = `
    ...
    .${scope} {
      ...
      --gleam-inset: rgba(56, 189, 248, 0.25);
      ...
      box-shadow: inset 0 0 0 1px var(--gleam-inset), 0 8px 24px -4px rgba(37, 99, 235, 0.35);
    ...
    .${scope}::after {
      ...
      mask-image: radial-gradient(circle at bottom, transparent 35%, black);
      opacity: ${showSheen ? 0.55 : 0};
    }
    ...
    .${scope}:is(:hover, :focus-visible) {
      ...
      box-shadow: inset 0 0 0 1px rgba(56, 189, 248, 0.5), 0 12px 32px -4px rgba(37, 99, 235, 0.65);
